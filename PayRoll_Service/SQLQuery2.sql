...
update employee_payroll set PhoneNo = 9513040209 where id = 1;
...
(1,'salma','F','Kerla',8569451236,'2020-10-2',301,201,300000),
(2,'Pranav','M','pune',4525369875,'2019-10-2',302,202,40000),
(3,'Varsha','F','Banglore',7514253672,'2020-10-2',301,203,600000);
